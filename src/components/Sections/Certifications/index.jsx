...
export default function CertificationsCard({ title, company, link, time, date, skills, languages,}) {
  ...
  return (
    <>
    <div className="align-margin-padd">
        <Card id="card-parent" className="max-sm:flex-col rounded-xl flex bg-gray-900/70 shadow-[0px_15px_15px_-5px_rgba(0,_0,_0,_0.5)] border-none">
        <div id="parent-information" className="max-sm:flex-col flex flex-row w-full">
            <div id="card-informations" className="max-sm:w-full flex-col w-4/12 ">
                <div id="title" className="flex flex-col gap-1">
                    <a className="hover:animate-pulse cursor-pointer" href={link}><h1 className="text-white text-xl font-mono">{title}</h1></a>
                    <p className="text-gray-400">{company}</p>
                </div>
            <div id="subtitle" className="flex text-gray-400 item-center max-sm:mt-3 mt-5 gap-5">
